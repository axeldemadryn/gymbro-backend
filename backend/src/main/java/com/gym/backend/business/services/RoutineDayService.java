...
public class RoutineDayService {
    ...
    public List<RoutineDay> findAllByUser(Long userId) {
        ...
        return repository.findAllByRoutineUserId(userId);
    }

    // 🔹 Nuevo método: obtener RoutineDay por day y fechas de WeeklyRoutine y
    // filtrado por User
    ...
    private void evaluarRutina(RoutineDay rd) {
        ...
        /*
         * El día de la semana debe caer dentro del rango de fechas (NOTA: el datesUntil
         * genera un Stream de
         * LocalDate)
         */
        ...
        /*
         * Validar que la sesión tenga al menos un ejercicio (el lado izquierdo de la
         * igualdad cuenta la cantidad
    ...
    public RoutineDay marcarCompletada(RoutineDay routine) {
        ...
        if (!LocalDate.now(zoneId)
                ...
                .isEqual(routine.getRoutine().getStartDate()
                        /*
                         * plusDays añade a la fecha (LocalDate) de inicio de la rutina semanal una
                         * cantidad de días dada
                         * para devolver otra fecha en consecuencia; y getValue devuelve el número de
                         * día del 1 al 7
                         * (LUNES=1 ... DOMINGO=7)
                         */
